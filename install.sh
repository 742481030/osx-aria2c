...
cd ~/Downloads
curl -sSO https://cdn.jsdelivr.net/gh/742481030/osx-aria2c@master/aria2c && say "下载完成" &&  ls && chmod 777 aria2c  && say "权限设置成功"
 cp ./aria2c /usr/local/bin/aria2c && say "安装到了系统目录"
...
# 从会话文件中读取下载任务
input-file=/Applications/aria2c/aria2c.session
# 在Aria2退出时保存`错误/未完成`的下载任务到会话文件
save-session=/Applications/aria2c/aria2c.session
